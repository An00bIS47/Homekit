...
#ifndef HAPPLUGINIRSWITCHDEVICE_HPP_
#define HAPPLUGINIRSWITCHDEVICE_HPP_
...
class HAPPluginIRSwitchDevice {
public:

    HAPPluginIRSwitchDevice();
    HAPPluginIRSwitchDevice(uint8_t houseAddress_, uint8_t deviceAddress_, String name_);
...
#endif /* HAPPLUGINIRSWITCHDEVICE_HPP_ */
