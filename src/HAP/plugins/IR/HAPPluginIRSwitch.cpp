...
#define IRSWITCH_RECV_PIN    14  // GPIO14
...
HAPPluginIRSwitch::HAPPluginIRSwitch(){
    ...
    _irrecv = new IRrecv(IRSWITCH_RECV_PIN);
    _newDevice  = nullptr;
}
...
//
void HAPPluginIRSwitch::dumpCode(decode_results *results)
{
    // Start declaration
...
// Dump out the decode_results structure.
//
void HAPPluginIRSwitch::dumpRaw (decode_results *results)
{
    // Print Raw data
    Serial.print("Timing[");
...
// Dump out the decode_results structure.
//
void HAPPluginIRSwitch::dumpInfo(decode_results *results)
{
...
//
void HAPPluginIRSwitch::encoding(decode_results *results)
{
...
// Display IR code
//
void HAPPluginIRSwitch::ircode(decode_results *results)
{
