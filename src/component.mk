...
ifeq ($(ENABLE_WEBSERVER),0)
	...
	ifeq ($(BOARD),HELTEC)
		...
		COMPONENT_EMBED_FILES += $(PROJECT_PATH)/certs/esp32-AF5FA4/esp32-AF5FA4.cer
	endif

	ifeq ($(BOARD),SPARKFUN)
		COMPONENT_EMBED_FILES += $(PROJECT_PATH)/certs/esp32-CAFEEC/esp32-CAFEEC.privatekey
		COMPONENT_EMBED_FILES += $(PROJECT_PATH)/certs/esp32-CAFEEC/esp32-CAFEEC.cer
	endif

	ifeq ($(BOARD),SPARKFUN2)
		COMPONENT_EMBED_FILES += $(PROJECT_PATH)/certs/esp32-CB3DC4/esp32-CB3DC4.privatekey
		COMPONENT_EMBED_FILES += $(PROJECT_PATH)/certs/esp32-CB3DC4/esp32-CB3DC4.cer
	endif

	ifeq ($(BOARD),HUZZAH)
		COMPONENT_EMBED_FILES += $(PROJECT_PATH)/certs/esp32-0C9D6C/esp32-0C9D6C.privatekey
		COMPONENT_EMBED_FILES += $(PROJECT_PATH)/certs/esp32-0C9D6C/esp32-0C9D6C.cer
	endif
